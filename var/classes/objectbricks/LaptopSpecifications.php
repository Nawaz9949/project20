 ...
 * - LaptopType [input]
 * - MSOfficeProvided [booleanSelect]
 * - ProcessorBrand [input]
 * - ProcessorName [input]
 * - ProcessorGeneration [input]
 * - SSD [input]
 * - SSDCapacity [input]
 * - RAM [input]
 * - DedicatedGraphicMemory [input]
 * - ClockSpeed [input]
 * - GraphicProcessor [input]
 * - NumberOfCores [numeric]
 * - OSArchitecture [input]
        ...
        array (
          ...
          Pimcore\Model\DataObject\ClassDefinition\Layout\Panel::__set_state(array(
            ...
            array (
              ...
              6 => 
              Pimcore\Model\DataObject\ClassDefinition\Data\Input::__set_state(array(
                 'name' => 'DedicatedGraphicMemory',
                 'title' => 'Dedicated Graphic Memory',
                 'tooltip' => '',
                 'mandatory' => false,
                 'noteditable' => false,
                 'index' => false,
